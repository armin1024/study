...
public class Receiver_1 {
    public static void main(String[] args) throws Exception {
        ...
        // 队列绑定交换机
        channel.queueBind(RabbitmqConstant.QUEEN_NAME_Q1, RabbitmqConstant.EXCHANGE_NAME_DIRECT, "armin");
        // 创建一个消费者  用来消费产品
        ...
        channel.basicConsume(RabbitmqConstant.QUEEN_NAME_Q1, true, consumer);
    }
}
